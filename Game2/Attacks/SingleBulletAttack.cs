...
{
    public class SingleBulletAttack : Attacks
    {
        int count = 1;//Bullet class is supposed to have only one bullet in its list

        public SingleBulletAttack(Texture2D newTexture, Vector2 origin)
        {
            texture = newTexture;
            position = origin;
            isVisible = true;
        ...
        public SingleBulletAttack(Texture2D newTexture, int count, Vector2 origin)
        {
            texture = newTexture;
            position = origin;
            isVisible = true;
